...
private var mContactEventHandlerValueSource2:Parameter_DirectConstant = new Parameter_DirectConstant (CoreClasses.GetNumberClassDefinition (), 0, null);
private var mContactEventHandlerValueSource1:Parameter_DirectConstant = new Parameter_DirectConstant (CoreClasses.GetEntityClassDefinition (), null, mContactEventHandlerValueSource2);
private var mContactEventHandlerValueSource0:Parameter_DirectConstant = new Parameter_DirectConstant (CoreClasses.GetEntityClassDefinition (), null, mContactEventHandlerValueSource1);
private var mContactEventHandlerValueSourceList:Parameter = mContactEventHandlerValueSource0;

private var mContactEventHandlerValueSource1_InvertEntityOrder:Parameter_DirectConstant = new Parameter_DirectConstant (CoreClasses.GetEntityClassDefinition (), null, mContactEventHandlerValueSource2);
private var mContactEventHandlerValueSource0_InvertEntityOrder:Parameter_DirectConstant = new Parameter_DirectConstant (CoreClasses.GetEntityClassDefinition (), null, mContactEventHandlerValueSource1_InvertEntityOrder);
