...
package editor.trigger.entity {
   ...
   {
      public function EntityEventHandler_GameLostOrGotFocus (world:World, defaultEventId:int, potientialEventIds:Array = null)
      {
...
//====================================================================
      ...
      {
         return new EntityEventHandler_GameLostOrGotFocus (mWorld, mEventId);
      }
