package wrapper {
   ...
   import flash.display.LoaderInfo;
    ...
    // Must be dynamic!
    public dynamic class PlayerPreloader extends MovieClip {
        public static var _mochiads_game_id:String = "dccbcf480583974b";
        //public static var _mochibot_id:String = "7a478df7"; // to g
        
        // Change this class name to your main class
        public static var MAIN_CLASS:String = "wrapper.ColorInfectionPlayer";
        public static var GAME_OPTIONS:Object = {id: _mochiads_game_id, res:"600x600"};
