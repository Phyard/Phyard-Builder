package com.tapirgames.util {
   // This is modified version in as3swf
	...
	public class MPEGFrame 
	{
		...
		public function get mono ():Boolean {return channelMode == 3;}
			...
			switch(index) {
				...
				case 1:
					...
					switch(mpegVersionBits) {
						...
						default: throw(new Error("Unsupported MPEG version: " + mpegVersionBits));
					}
					...
					switch(mpegLayerBits) {
						...
						default: throw(new Error("Unsupported MPEG layer: " + mpegLayerBits));
					}
				...
				case 2:
					...
					if (samplingrateIndex == 3) {
						throw(new Error("Unsupported samplingrate index: " + samplingrateIndex));
					}
