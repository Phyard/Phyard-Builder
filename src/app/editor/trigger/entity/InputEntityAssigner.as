...
package editor.trigger.entity {
   ...
   public class InputEntityAssigner extends Sprite implements Linkable
   {
...
//=================================================================================================
    ...
    // ...
      ...
      public function InputEntityAssigner (container:Scene, ownerEntity:Entity, inputId:int = 0, selectorId:int = 0, onSelectEntity:Function = null, onClearEntities:Function = null)
      {
...
//====================================================================
      ...
      {
         var selector:InputEntityAssigner = event.mouseTarget as InputEntityAssigner;
         if (selector != this)
            return;
