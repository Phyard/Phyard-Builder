...
package editor.trigger.entity {
   ...
   public class EntityEventHandler_Touch extends EntityEventHandler 
   {
      public function EntityEventHandler_Touch (container:Scene, defaultEventId:int, potientialEventIds:Array = null)
      {
...
//====================================================================
      ...
      {
         return new EntityEventHandler_Touch (mEntityContainer, mEventId);
      }
      ...
      override public function SetPropertiesForClonedEntity (entity:Entity, displayOffsetX:Number, displayOffsetY:Number):void // used internally
      {
         ...
         var mouseHandler:EntityEventHandler_Touch = entity as EntityEventHandler_Touch;
      }
