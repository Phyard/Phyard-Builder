...
package editor.trigger.entity {
   ...
   {
      public function EntityEventHandler_ModuleLoopToEnd (world:World, defaultEventId:int, potientialEventIds:Array = null)
      {
...
//====================================================================
      ...
      {
         return new EntityEventHandler_ModuleLoopToEnd (mWorld, mEventId);
      }
