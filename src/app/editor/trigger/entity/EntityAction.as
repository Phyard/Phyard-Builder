...
package editor.trigger.entity {
   ...
   public class EntityAction extends EntityCodeSnippetHolder
   {
      ...
      // text
         ...
         var text:String = "Action"; //mCodeSnippet.GetName ();
      ...
      // background
         ...
         GraphicsUtil.ClearAndDrawRect (background, - mHalfWidth, - mHalfHeight, mHalfWidth + mHalfWidth, mHalfHeight + mHalfHeight, borderColor, mBorderThickness, true, 0xFFA0A0);
