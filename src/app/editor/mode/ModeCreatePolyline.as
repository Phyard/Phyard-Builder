package editor.mode {
   ...
   public class ModeCreatePolyline extends ModeCreateShape
   {
      ...
      public function ModeCreatePolyline (mainView:WorldView, ciAiType:int, filledColor:uint, isStatic:Boolean, isSquare:Boolean = false, minSideLength:Number = EditorSetting.MinRectSideLength) //, maxSideLength:Number = EditorSetting.MaxRectSideLength)
      {
