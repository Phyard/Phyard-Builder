...
package editor.trigger.entity {
   ...
   public class EntityInputEntityPairScriptFilter extends EntityCodeSnippetHolder implements IEntityLimiter 
   {
      public function EntityInputEntityPairScriptFilter (world:World)
      {
         ...
         mCodeSnippet = new CodeSnippet (new FunctionDefinition (mWorld.GetTriggerEngine (),TriggerEngine.GetEntityPairFilterFunctionDeclaration ()));
...
//====================================================================
      ...
      {
         return new EntityInputEntityPairScriptFilter (mWorld);
      }
